...
<div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <a href="{{route('post.edit',$post->id)}}" class="btn btn-secondary float-right">Edit</a>
...
@endif
        ...
        <div class="media mb-4">
              <img class="d-flex mr-3 rounded-circle w-25" src="{{asset($row->user->avatar)}}" width="35px" height="35px" alt="photo">
